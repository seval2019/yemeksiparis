...
const CampaignItem = () => {
  return (
    <div className="bg-secondary flex-1 rounded-md py-5 px-[15px] flex items-center gap-x-4">
      <div className="relative sm:w-44 md:h-44 w-36 h-36 after:content-['']  border-[5px] border-primary rounded-full overflow-hidden">
        <Image
          src="/images/o1.jpg"
          alt=""
          layout="fill"
      ...
      <div className="text-white">
        ...
        <button className="btn-primary flex items-center gap-x-2 rounded-full">
